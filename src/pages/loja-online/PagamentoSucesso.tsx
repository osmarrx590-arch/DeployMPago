  ...
  useEffect(() => {
    const processarPagamento = async () => {
      try {
        ...
        console.log('✅ Pagamento aprovado! Processando pedido...', pedidoPendente);
        ...
        toast({
          ...
          description: `Pedido #${pedidoSalvo.numero} foi registrado com sucesso.`,
          duration: 5000,
        });
      } catch (error) {
        ...
        toast({
          ...
          description: "Houve um problema ao finalizar seu pedido. Entre em contato conosco.",
          variant: "destructive",
          duration: 5000,
        });
      } finally {
    ...
    <div className="container mx-auto py-12 px-4">
      <Card className="w-full max-w-md mx-auto text-center">
        <CardHeader>
          ...
          <CardDescription>
            {numeroPedido ? `Pedido #${numeroPedido} processado com sucesso.` : 'Seu pedido foi processado com sucesso.'}
          </CardDescription>
        </CardHeader>
        <CardContent>
